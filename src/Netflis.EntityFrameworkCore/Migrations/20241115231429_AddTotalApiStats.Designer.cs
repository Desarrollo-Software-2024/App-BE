...
{
    [DbContext(typeof(NetflisDbContext))]
    [Migration("20241115231429_AddTotalApiStats")]
    partial class AddTotalApiStats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Netflis.Capitulos.Capitulo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppCapitulos", (string)null);
                });

            modelBuilder.Entity("Netflis.ListaSeguimientos.ListaSeguimiento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Netflis.MonitoreoApi.ApiAccessLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppApiAccessLog", (string)null);
                });

            modelBuilder.Entity("Netflis.MonitoreoApi.TotalApiMonitoringStats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppTotalApiMonitoringStats", (string)null);
                });

            modelBuilder.Entity("Netflis.Notificaciones.CapituloAdded", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("capituloNumero")
                        .HasColumnType("int");

                    b.Property<string>("temporadaId")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.ToTable("AppCapituloAdded", (string)null);
                });

            modelBuilder.Entity("Netflis.Notificaciones.SerieUpdated", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppSerieUpdated", (string)null);
                });

            modelBuilder.Entity("Netflis.Notificaciones.TemporadaAdded", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppTemporadaAdded", (string)null);
                });

            modelBuilder.Entity("Netflis.Series.Serie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Netflis.Temporadas.Temporada", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Netflis.Capitulos.Capitulo", b =>
                {
                    b.HasOne("Netflis.Temporadas.Temporada", "Temp")
                        .WithMany("Capitulos")
            ...
            modelBuilder.Entity("Netflis.Series.Serie", b =>
                {
                    b.HasOne("Netflis.ListaSeguimientos.ListaSeguimiento", null)
                        .WithMany("Series")
            ...
            modelBuilder.Entity("Netflis.Temporadas.Temporada", b =>
                {
                    b.HasOne("Netflis.Series.Serie", "Serie")
                        .WithMany("Temporadas")
